...
import org.lwjgl.nanovg.NanoVG.{nvgBeginFrame, nvgBeginPath, nvgCircle, nvgCreateFontMem, nvgEndFrame, nvgFill, nvgFillColor, nvgFontFace, nvgFontSize, nvgRect, nvgText, nvgTextAlign}
import org.lwjgl.nanovg.NanoVGGL3.nvgCreate
import zio.{Has, UIO, ZLayer}

package object nvg {

  type NVG = Has[NVG.Service]

  object NVG extends Serializable {
